...
## Monetization (once the above earns it)

- **Free** — up to 5 habits, streaks, basic tracking
- **Pro ($3–5/mo)** — unlimited habits, analytics, heatmaps, reminders, reports, categories
- **Premium ($8–12/mo)** — AI coach, AI reviews, goal planning, health integrations, exports

No billing integration exists yet — tier gating is a Phase 2+ concern once there's
