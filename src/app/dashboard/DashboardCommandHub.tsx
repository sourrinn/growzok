  ...
  return (
    <div className="space-y-8">
      ...
      <div className="rounded-3xl border border-[#e5e1d7] bg-white p-6 sm:p-8 shadow-sm dark:border-[#27272a] dark:bg-[#18181b] space-y-6">
        <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
          <div>
            ...
            <h1 className="mt-2 font-display text-2xl sm:text-4xl font-bold tracking-tight text-[#232f26] dark:text-[#f4f4f5]">
          ...
          <div className="flex items-center gap-4 shrink-0">
            <div className="text-right">
              <div className="font-mono text-3xl sm:text-5xl font-bold text-[#406852] dark:text-[#a3b899]">
                {completionRatePct}%
              </div>
              <span className="text-[11px] text-[#737970] dark:text-[#a1a1aa] font-medium">
      ...
      <div className="grid gap-8 lg:grid-cols-12">
                ...
                <div key={habit.id} className="flex items-center justify-between rounded-2xl border border-[#e5e1d7] bg-white p-4 dark:border-[#27272a] dark:bg-[#18181b] shadow-xs">
                  <div className="flex items-center gap-3">
                    <button
                      ...
                      className="flex h-6 w-6 items-center justify-center rounded-lg border-2 border-[#406852] text-[#406852] dark:border-[#a3b899] dark:text-[#a3b899] font-bold text-xs hover:bg-[#406852]/10"
                    >
                      ✓
                    </button>
                    <div>
        ...
        {/* Right Column: Bio Workstations Quick Launch Rail */}
