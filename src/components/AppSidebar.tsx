...
export default function AppSidebar({
  ...
  return (
    <aside className="flex h-full flex-col justify-between border-r border-[#e5e1d7] bg-[#fbf9f5] p-3 text-[#232f26] transition-all duration-300">
      {/* Top Section */}
            ...
            <>
              ...
              {onToggleCollapse && (
                <button
                  ...
                  className="rounded-lg p-1.5 text-[#737970] transition-colors hover:bg-[#e5e1d7]/60 hover:text-[#232f26]"
                >
            ...
            <div className="flex w-full items-center justify-center">
              {onToggleCollapse && (
                <button
                  ...
                  className="flex h-8 w-8 items-center justify-center rounded-xl bg-[#232f26] text-sm font-bold text-white transition-opacity hover:opacity-90"
                >
                  G
                </button>
              )}
